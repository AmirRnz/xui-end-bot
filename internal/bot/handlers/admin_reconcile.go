...
func isFinancialReconcileKind(kind string) bool {
	switch kind {
	case reconcile.KindPendingRefund, reconcile.KindPurchaseProvisioningUnknown,
		reconcile.KindPurchaseRemoteCreatedDbFailed, reconcile.KindDirectPaymentProvisioningRetry:
		return true
	default:
		return false
	}
